...
import { Devs, SlipcordDevs, GUILD_ID, SUPPORT_CHANNEL_ID, SUPPORT_CHANNEL_IDS, VC_SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
migratePluginToSettings(true, "SlipcordHelper", "NoBulletPoints", "noBulletPoints");
migratePluginToSettings(true, "SlipcordHelper", "NoModalAnimation", "noModalAnimation");
migratePluginToSettings(true, "SlipcordHelper", "GuildTagSettings", "disableAdoptTagPrompt");
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    ...
                    body: "Before asking for help. Check updates and if this issue is actually caused by Slipcord!",
                    confirmText: "Slipcord Support",
                    onConfirm() {
