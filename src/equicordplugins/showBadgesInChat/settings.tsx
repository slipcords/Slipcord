...
const settings = definePluginSettings({
    showSlipcordDonor: {
        ...
        description: "Enable to show Slipcord Donor badges in chat.",
        hidden: true,
        default: true
    },
    SlipcordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Slipcord Donor badges.",
        hidden: true,
        default: 0
    },
    showSlipcordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Slipcord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    SlipcordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Slipcord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        ...
        { src: "https://equicord.org/assets/favicon.png", shown: settings.store.showSlipcordContributor, title: "Slipcord contributor badge", key: "SlipcordContributer", position: settings.store.SlipcordContributorPosition },
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "SlipcordDonor":
                    settings.store.SlipcordDonorPosition = image.position;
                    settings.store.showSlipcordDonor = image.shown;
                    break;
                case "SlipcordContributer":
                    settings.store.SlipcordContributorPosition = image.position;
                    settings.store.showSlipcordContributor = image.shown;
                    break;
                case "VencordDonor":
