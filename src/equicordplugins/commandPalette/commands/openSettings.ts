...
export const DISCORD_SETTINGS_ROUTES: SettingsRoute[] = [
    ...
    { route: "equicord_main", label: "Slipcord", keywords: ["vencord"] },
    { route: "equicord_plugins", label: "Slipcord Plugins", keywords: ["plugins"] },
    { route: "equicord_themes", label: "Slipcord Themes", keywords: ["themes", "css"] },
    { route: "equicord_updater", label: "Slipcord Updater", keywords: ["update"] },
    { route: "equicord_changelog", label: "Slipcord Changelog", keywords: ["changelog", "news"] }
];
