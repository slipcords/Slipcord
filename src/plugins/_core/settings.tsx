...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Slipcord settings section",
        options: [
    ...
    includeVencordInfoWhenCopying: {
        ...
        description: "Also copy Slipcord info (Slipcord, Electron, Chromium) when clicking the version info in the bottom left area of the Settings page",
        default: true
    }
});
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        if (layout.some(s => s?.key === "slipcord_section")) return layout;

        const { buildEntry } = this;

        const slipcordEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "slipcord_main",
                title: "Slipcord",
                panelTitle: "Slipcord Settings",
                Component: VencordTab,
                Icon: MainSettingsIcon
            }),
            buildEntry({
                key: "slipcord_plugins",
                title: "Plugins",
            ...
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                key: "slipcord_updater",
                title: "Updater",
                panelTitle: "Slipcord Updater",
                Component: UpdaterTab,
                Icon: UpdaterIcon
            }),
            buildEntry({
                key: "slipcord_changelog",
                title: "Changelog",
            ...
            buildEntry({
                key: "slipcord_cloud",
                title: "Cloud",
                panelTitle: "Slipcord Cloud",
                Component: CloudTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "slipcord_backup_restore",
                title: "Backup & Restore",
                Component: BackupAndRestoreTab,
                Icon: BackupRestoreIcon
            }),
            !IS_STANDALONE && PatchHelperTab && buildEntry({
                key: "slipcord_patch_helper",
                title: "Patch Helper",
        ...
        const slipcordSection: SettingsLayoutNode = {
            key: "slipcord_section",
            type: LayoutTypes.SECTION,
            useTitle: () => "Slipcord Settings",
            buildLayout: () => slipcordEntries
        };
        ...
        layout.splice(idx, 0, slipcordSection);
    ...
    getInfoRows() {
        ...
        const rows = [`Slipcord ${gitHashShort}${getVersionInfo()}`];
