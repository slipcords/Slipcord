...
export const slipcordCommands: PaletteCommand[] = [
    {
        id: "slipcord.settings",
        title: "Open Slipcord Settings",
        section: SECTION,
        keywords: ["slipcord", "vencord", "settings"],
        icon: GearIcon,
        actions: [{
            id: "run",
            label: "Open Slipcord Settings",
            run: () => void openSettingsPage("slipcord_main")
        }]
    },
    {
        id: "slipcord.quickCss",
        title: "Open QuickCSS",
        section: SECTION,
    ...
    },
    {
        ...
        actions: [{
            id: "run",
            label: "Open Updater",
            run: () => void openSettingsPage("slipcord_updater")
        }]
    },
    {
        id: "slipcord.changelog",
        ...
        actions: [{
            ...
            run: () => void openSettingsPage("slipcord_changelog")
        }]
    },
    {
        id: "slipcord.restart",
