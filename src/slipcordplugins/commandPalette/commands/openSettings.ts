...
export const DISCORD_SETTINGS_ROUTES: SettingsRoute[] = [
    ...
    { route: "slipcord_main", label: "Slipcord", keywords: ["vencord"] },
    { route: "slipcord_plugins", label: "Slipcord Plugins", keywords: ["plugins"] },
    { route: "slipcord_themes", label: "Slipcord Themes", keywords: ["themes", "css"] },
    { route: "slipcord_updater", label: "Slipcord Updater", keywords: ["update"] },
    { route: "slipcord_changelog", label: "Slipcord Changelog", keywords: ["changelog", "news"] }
];
...
const ROUTE_ALIASES = new Map<string, string[]>([
    ...
    ["slipcord_main", ["slipcord_main_panel"]],
    ["slipcord_plugins", ["slipcord_plugins_panel"]],
    ["slipcord_themes", ["slipcord_themes_panel"]],
    ["slipcord_updater", ["slipcord_updater_panel"]],
    ["slipcord_changelog", ["slipcord_changelog_panel"]]
]);
