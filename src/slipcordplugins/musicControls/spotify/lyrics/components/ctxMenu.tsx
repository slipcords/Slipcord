...
import { providers } from "@slipcordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@slipcordplugins/musicControls/spotify/lyrics/providers/store";
