...
import { LyricsData, Provider } from "@slipcordplugins/musicControls/spotify/lyrics/providers/types";
import { Track } from "@slipcordplugins/musicControls/spotify/SpotifyStore";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for Slipcord (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
