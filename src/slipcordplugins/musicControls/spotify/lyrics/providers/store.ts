...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@slipcordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@slipcordplugins/musicControls/spotify/SpotifyStore";
