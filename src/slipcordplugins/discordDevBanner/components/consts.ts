...
export const settings = definePluginSettings({
    format: {
        ...
        default: "{slipcordIcon} Slipcord {slipcordVersion} ({slipcordHash})",
        restartNeeded: true
    }
});
...
export const settingVariables = [
    ...
    "",
    "Slipcord Variables:",
    "{slipcordIcon} - Slipcord icon",
    "{slipcordVersion} - Version of Slipcord (e.g. 1.0.0)",
    "{slipcordHash} - Slipcord build hash (e.g. 123456789)",
    "{slipcordPlatform} - Platform Slipcord is running on (e.g. Dev Build)",
    "",
