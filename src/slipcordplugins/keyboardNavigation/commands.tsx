...
export const actions: ButtonAction[] = [
    { id: "openSlipcordSettings", label: "Open Slipcord tab", callback: async () => await SettingsRouter.openUserSettings("slipcord_main_panel"), registrar: "Slipcord" },
    { id: "openPluginSettings", label: "Open Plugin tab", callback: () => SettingsRouter.openUserSettings("slipcord_plugins_panel"), registrar: "Slipcord" },
    { id: "openThemesSettings", label: "Open Themes tab", callback: () => SettingsRouter.openUserSettings("slipcord_themes_panel"), registrar: "Slipcord" },
    { id: "openUpdaterSettings", label: "Open Updater tab", callback: () => SettingsRouter.openUserSettings("slipcord_updater_panel"), registrar: "Slipcord" },
    { id: "openSlipcordCloudSettings", label: "Open Cloud tab", callback: () => SettingsRouter.openUserSettings("slipcord_cloud_panel"), registrar: "Slipcord" },
    { id: "openBackupSettings", label: "Open Backup & Restore tab", callback: () => SettingsRouter.openUserSettings("slipcord_backup_restore_panel"), registrar: "Slipcord" },
    { id: "restartClient", label: "Restart Client", callback: () => relaunch(), registrar: "Slipcord" },
    { id: "openQuickCSSFile", label: "Open Quick CSS File", callback: () => VencordNative.quickCss.openEditor(), registrar: "Slipcord" },
    { id: "openSettingsFolder", label: "Open Settings Folder", callback: async () => showItemInFolder(await VencordNative.settings.getSettingsDir()), registrar: "Slipcord" },
    { id: "openInGithub", label: "Open in Github", callback: async () => VencordNative.native.openExternal(await getRepo()), registrar: "Slipcord" },
        ...
        id: "checkForUpdates", label: "Check for Updates", callback: async () => {
            ...
            if (isOutdated) {
                setTimeout(() => showNotification({
                    title: "A Slipcord update is available!",
                    body: "Click here to view the update",
                    permanent: true,
                    noPersist: true,
                    onClick() {
                        SettingsRouter.openUserSettings("slipcord_updater_panel");
                    }
                }), 10_000);
            } else {
                Toasts.show({
