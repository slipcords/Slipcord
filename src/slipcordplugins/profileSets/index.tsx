...
export default definePlugin({
    ...
    toolboxActions: {
        "Open Profile Sets": () => {
            SettingsRouter.openUserSettings("slipcord_profile_sets_panel");
        },
    },
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "slipcord_profile_sets");
    },
});
