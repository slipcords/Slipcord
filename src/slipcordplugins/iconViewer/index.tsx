...
export default definePlugin({
    ...
    toolboxActions: {
        "Open Icons Tab"() {
            SettingsRouter.openUserSettings("slipcord_icon_viewer_panel");
        },
    },
    settingsAboutComponent: SettingsAbout,
    start() {
        SettingsPlugin.customEntries.push({
            key: "slipcord_icon_viewer",
            title: "Icon Finder",
            Component: IconsTab,
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "slipcord_icon_viewer");
    },
});
