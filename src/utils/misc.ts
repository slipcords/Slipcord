...
export const isSlipcordPluginDev = (id: string) => Object.hasOwn(SlipcordDevsById, id);
export const shouldShowSlipcordContributorBadge = (id: string) => isSlipcordPluginDev(id) && SlipcordDevsById[id].badge !== false;

export const isAnyPluginDev = (id: string) => Object.hasOwn(VencordDevsById, id) || Object.hasOwn(SlipcordDevsById, id);
...
export function isSlipcordGuild(id: string | null | undefined, isGuildId: boolean = false): boolean {
    if (!id) return false;
...
export function isSlipcordSupport(userId: string | null | undefined): boolean {
