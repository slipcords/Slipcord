...
export interface PluginDef {
    ...
    /*
    * Custom apis added by Slipcord and were placed here for quicker identification rather then mixing them in
    */
    ...
    /**
     * A Vencord plugin that is modified for extra features in Slipcord
     */
    isModified?: boolean;
}
