...
const SHIGGY_DONATE_IMAGE = "https://raw.githubusercontent.com/slipcords/Slipper/main/build/icon.png";
        ...
        <SettingsTab>
            {(isSlipcordDonor(user?.id) || isVencordDonor(user?.id)) ? (
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Slipcord by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Slipcord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Slipcord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
