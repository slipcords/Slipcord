        ...
        <SettingsTab>
            ...
            <div className="vc-settings-switches">
                <FormSwitch
                    ...
                    description="When enabled, Slipcord will automatically download and install updates in the background without asking for confirmation. You'll need to restart Discord to apply the changes."
                ...
                <FormSwitch
                    ...
                    description="Receive a notification when Slipcord finishes downloading an update in the background, so you know when to restart Discord."
            ...
            <Paragraph className={Margins.bottom8}>
                This is the GitHub repository where Slipcord fetches updates from.
            </Paragraph>
