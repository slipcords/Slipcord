...
const CHANGELOG_HISTORY_KEY = "SlipcordChangelog_History";
const LAST_SEEN_HASH_KEY = "SlipcordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "SlipcordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "SlipcordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "SlipcordChangelog_LastRepoCheck";
