...
async function buildExtension(target, files) {
    const entries = {
        "dist/Slipcord.js": await readFile("dist/browser/extension.js"),
        "dist/Slipcord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Slipcord.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/Slipcord.user.js", cssRuntime);
});
