...
const BASE_URL = "https://github.com/Slipcords/Slipped/releases/latest/download/";
const INSTALLER_PATH_DARWIN = "Slipped.app/Contents/MacOS/Slipped";
const INSTALLER_APP_DARWIN = "Slipped.app";
...
function getFilename() {
    switch (process.platform) {
        case "win32":
            return "SlippedCli.exe";
        case "darwin":
            switch (process.arch) {
                case "x64":
                    return "Slipped-darwin-x64.zip";
                case "arm64":
                    return "Slipped-darwin-arm64.zip";
                default:
                    throw new Error("Unsupported macOS architecture: " + process.arch);
            }
        case "linux":
            return "SlippedCli-linux";
        default:
...
async function ensureBinary() {
    ...
    const res = await fetch(BASE_URL + filename, {
        headers: {
            "User-Agent": "Slipcord (https://github.com/Slipcord/Slipcord)",
            "If-None-Match": etag
        }
    });
...
try {
    execFileSync(installerBin, args, {
        ...
        env: {
            ...process.env,
            SLIPCORD_USER_DATA_DIR: BASE_DIR,
            SLIPCORD_DIRECTORY: join(BASE_DIR, "dist/desktop"),
            SLIPCORD_DEV_INSTALL: "1"
        }
    });
} catch {
